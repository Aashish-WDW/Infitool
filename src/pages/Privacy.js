...
function Privacy() {
    return (
        // <div>
        //     <h1>Privacy Policy for InfiTool</h1>

        //     <p>At InfiTool, accessible from InfiTool.com, one of our main priorities is the privacy of our visitors. This Privacy
        //         Policy document contains types of information that is collected and recorded by InfiTool and how we use it.</p>
        ...
        //     <p>InfiTool follows a standard procedure of using log files. These files log visitors when they visit websites. All
        ...
        //     <p>Some of advertisers on our site may use cookies and web beacons. Our advertising partners are listed below. Each of
        ...
        //     <p>You may consult this list to find the Privacy Policy for each of the advertising partners of InfiTool.</p>

        //     <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
        //         their respective advertisements and links that appear on InfiTool, which are sent directly to users' browser. They
        ...
        //     <p>Note that InfiTool has no access to or control over these cookies that are used by third-party advertisers.</p>

        //     <h2>Third Party Privacy Policies</h2>

        //     <p>InfiTool's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the
        ...
        //     <p>InfiTool does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you
        ...
        // </div>
        <div>
            <Link href='https://www.freeprivacypolicy.com/live/fbfe9203-8b8a-4876-9e92-4a95202366f2'></Link>
        </div>
    )
}
